    ...
    return(
        <>
            ...
            <section  className="py-20" >
                <div data-aos='fade-down' className="px-5 text-center text-gray-800 items-center mb-20 ">
                ...
                <div className="px-10 md:px-25 lg:px-50 min-xl:px-60 grid grid-cols-1 min-xl:grid-cols-2  justify-center items-center gap-y-20 gap-x-5  text-gray-600">
                    <div data-aos='fade-right' className="p-10 justify-center flex flex-col  min-xl:h-120 bg-white shadow-md rounded-xl ">
                        <div>
                            <h1 className=" text-xl text-center font-semibold min-sm:text-2xl mb-5  ">Conseil et sécurité juridique</h1>
                            ...
                            <div className="flex flex-col space-y-4">
                                <h1 className="texmdxl font-semibold">Prestations</h1>
                    ...
                    <div  data-aos='fade-right' className=" p-10 justify-center flex flex-col min-xl:h-120 bg-white shadow-md rounded-xl">
                        <h1 className=" text-xl text-center font-semibold min-sm:text-2xl mb-5 text-gray-600 ">Gouvernance & Conformité</h1>
                    ...
                    <div  data-aos='fade-left' className=" p-10 justify-center flex flex-col min-xl:h-120 bg-white shadow-md rounded-xl">
                        <h1 className=" text-xl text-center font-semibold min-sm:text-2xl mb-5 text-gray-600 ">Réglementation & Veille</h1>
                    ...
                    <div  data-aos='fade-right' className=" p-10 justify-center flex flex-col min-xl:h-120 bg-white shadow-md rounded-xl">
                        <h1 className=" text-xl text-center font-semibold min-sm:text-2xl mb-5 text-gray-600 ">Projets Stratégiques</h1>
                    ...
                    <div  data-aos='fade-left' className=" p-10 justify-center flex flex-col min-xl:h-120 bg-white shadow-md rounded-xl">
                        <h1 className=" text-xl text-center font-semibold min-sm:text-2xl mb-5 text-gray-600 ">Relations Institutionnelles</h1>
