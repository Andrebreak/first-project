    ...
    return(
        <>
            ...
            <div className="p-0 m-0 flex items-baseline">
                <p className={` ${playfair.className} `}> <span className="text-[240px] sm:text-[300px] md:text-[380px] min-lg:text-[500px] tracking-[-40px]  sm:tracking-[-40px] md:tracking-[-60px] min-lg:tracking-[-75px]">AD</span></p>
